...
`AGENTS.md` (racine) reste la fiche opérationnelle courte : stack, commandes, invariants.
Ce wiki porte le *pourquoi* — ce qui ne se relit ni dans le code, ni dans `AGENTS.md`.
